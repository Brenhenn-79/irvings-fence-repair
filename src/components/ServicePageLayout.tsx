  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', minHeight: '500px', height: 'auto', overflow: 'hidden' }}>
        ...
        <div className="service-hero-content" style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto', padding: '80px 24px 80px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1.1rem', maxWidth: '600px', lineHeight: 1.6, marginBottom: '24px' }}>
            {intro}
          </p>
      ...
      <section style={{ padding: '64px 24px', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div className="service-grid">
            ...
            {/* Left Content */}
            <div>
              <div className="benefits-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '16px', marginBottom: '48px' }}>
                {benefits.map(b => (
            ...
            {/* Right: Form */}
            <div id="quote" className="service-sidebar" style={{ position: 'sticky', top: '90px', background: 'white', borderRadius: '20px', padding: '32px', border: '1px solid #E2E8F0', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
              <ContactForm
